...
#include "agent_engine/network/anet/channelpool.h"
...
#include "agent_engine/network/anet/orderedpacketqueue.h"
#include "agent_engine/network/anet/packet.h"
#include "agent_engine/network/anet/socket.h"
#include "agent_engine/network/anet/stats.h"
...
Connection::Connection(Socket *socket, IPacketStreamer *streamer, IServerAdapter *serverAdapter) {
    ...
    _readWriteBufSize = util::EnvUtil::GetEnv("ANET_READ_WRITE_SIZE", _readWriteBufSize);
}
