...
public:
    ...
    void markRequestPackBegin() { _requestPackBeginTimeUs = util::TimeUtility::CurrentTimeInMicroSeconds(); }
    void markRequestPackDone() { _requestPackDoneTimeUs = util::TimeUtility::CurrentTimeInMicroSeconds(); }
    int64_t requestPackCostUs() const { return nonZeroSubtract(_requestPackDoneTimeUs, _requestPackBeginTimeUs); }

    void markRequestSendBegin() { _requestSendBeginTimeUs = util::TimeUtility::CurrentTimeInMicroSeconds(); }
    void markRequestSendDone() { _requestSendDoneTimeUs = util::TimeUtility::CurrentTimeInMicroSeconds(); }
    ...
    void markResponsePopBegin(int64_t timeUs = 0) {
        ...
        _responsePopBeginTimeUs = util::TimeUtility::CurrentTimeInMicroSeconds();
    }
    void markResponsePopDone() { _responsePopDoneTimeUs = util::TimeUtility::CurrentTimeInMicroSeconds(); }
    ...
    void markResponseUnpackBegin() { _responseUnpackBeginTimeUs = util::TimeUtility::CurrentTimeInMicroSeconds(); }
    void markResponseUnpackDone() { _responseUnpackDoneTimeUs = util::TimeUtility::CurrentTimeInMicroSeconds(); }
