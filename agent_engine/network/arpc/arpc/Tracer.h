...
inline void Tracer::BeginPostRequest() {
    _beginPostRequest = util::TimeUtility::CurrentTime();
    if (_clientStats != nullptr) {
...
inline void Tracer::BeginHandleResponse() {
    _beginHandleResponse = util::TimeUtility::CurrentTime();
    if (_clientStats != nullptr) {
...
inline void Tracer::BeginHandleRequest() { SetBeginHandleRequest(util::TimeUtility::CurrentTime()); }

inline void Tracer::EndDecodeRequest() {
    _endHandleRequest = util::TimeUtility::CurrentTime();
    if (_serverStats != nullptr) {
...
inline void Tracer::BeginWorkItemProcess() {
    _beginWorkItemProcess = util::TimeUtility::CurrentTime();
    if (_serverStats != nullptr) {
...
inline void Tracer::BeginPostResponse() {
    _beginPostResponse = util::TimeUtility::CurrentTime();
    if (_serverStats != nullptr) {
